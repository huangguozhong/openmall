...
import com.openmall.manager.dao.TbItemParamMapper;
import com.openmall.manager.pojo.TbItemParam;
import com.openmall.manager.pojo.TbItemParamExample;
import com.openmall.manager.pojo.TbItemParamExample.Criteria;
...
public class ItemParamServiceImpl implements ItemParamService {
	...
	@Override
	public TaotaoResult deleteItemParamByIds(List<Long> ids) {
		TbItemParamExample example = new TbItemParamExample();
		Criteria criteria = example.createCriteria();
